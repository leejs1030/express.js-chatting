...
const getChannelsByUserId = async (uid: string, task = db): Promise<channelInfo[]> =>{
...
const getMemberFromChannel = async(cid: number, uid: string, task = db): Promise<user[]> =>{
...
const getFriendsByIdNotInChannel = async (uid: string, cid: any, task = db): Promise<user[]> =>{
